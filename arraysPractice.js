...
/*
  ...
  matches an item in myGroceryList, remove that item from the your grocery list and return the new, updated
  grocery list.

  Once you do that, write another function called addItem that is given two arguments, the first is
  myGroceryList and the second is an item to add to your grocery list. In addItem add the item you passed
  in to myGroceryList then return the new, updated grocery list.
...
sure that it's equal to 4. */
  ...
  //Code Here
var dvmtnEmp = function (arr, obj) {
  arr.push(obj);
};

dvmtnEmp(devMountainEmployees, tyler);
dvmtnEmp(devMountainEmployees, cahlan);
dvmtnEmp(devMountainEmployees, ryan);
dvmtnEmp(devMountainEmployees, colt);

/*Now let's say Cahlan has a mental breakdown and has to take a leave of absence to 'find himself'.
Loop through your devMountainEmployees until you find cahlan, then remove him from the array.*/

  //Code Here
var leaveOfAbsence = function (array, obj) {
...
leaveOfAbsence(devMountainEmployees, cahlan);
...
//Your Code Here
var user2 = {
    name: 'Jon Holmesmitherson',
    email: 'fakeemail@notreal.com',
    password: 'password',
    username: 'Jonny Holmey'
};

var user3 = {
    name: 'Francis Baldeverene',
    email: 'anonymous@madeup.com',
    password: '12345abcde',
    username: 'Sir Francis B'
};
